...
<body>
    ...
    <main class="container-main">
        <div class="container single-product mt-0 mt-lg-5 mr-5">
            <div class="main-product mt-5">
                ...
                <div class="product-images d-flex justify-content-center flex-direction-column align-self-start mt-5 ms-sm-5">
                    <div class="thumbnail-carousel d-flex flex-wrap">
                        @foreach ($produto->imagens->take(3) as $imagem)
                        <img src="{{ $imagem->IMAGEM_URL }}" alt="Thumbnail 1" class="thumbnail mb-3">
                        @endforeach
                    </div>
                </div>
            </div>
            <div class="view-information ms-md-5 mt-5">
