...
<div class="row mt-3 mb-3 d-flex justify-content-between" style="position: relative;">
  ...
  <div class="col-6" style="margin-left: 120px;">
    <form class="form-inline">
      <input class="form-control mr-2 searchbar" style="display: inline-block; max-width: 545px;" type="text"
        placeholder="Qual produto você está buscando?" style="width: 80%;">
      <button class="btn btn-primary btn-search" type="submit"><i class="fa fa-search"></i></button>
    </form>
  </div>
  <div class="col-2">
    <button class="btn text-uppercase fw-bold btn-login"><a href="/login"> <img src="{{ asset('images/icon-account.png') }}" alt=""> Entrar /
      Cadastrar</a></button>
  </div>
  <div class="col-2">
